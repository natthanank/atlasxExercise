...
export class AuthService {
  ...
  isLoggedIn(): Observable<boolean> {
    if (this.appService.appConfig != null) {
      ...
      return this.appService.reqUrl(`${this.appService.hostName}Handlers/AppInit.ashx`, null, ResponseType.json).pipe(
        map(response => {
  ...
  login(credential: any): Observable<any> {
    return this.appService.reqUrl(`${this.appService.hostName}/Handlers/AppLogin.ashx`, credential, ResponseType.json).pipe(
      map(response => {
        if (response.success) {
  ...
  logout(): Observable<any> {
    return this.appService.reqUrl(`${this.appService.hostName}/Handlers/AppLogout.ashx`, null, ResponseType.json).pipe(
      map(response => {
        if (response.success) {
